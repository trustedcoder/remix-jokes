                ...
                <div className="grid grid-cols-4 gap-4">
                  ...
                  {data.jokeListItems.map((joke) => (
                    <div className="border-x border-y mb-2 px-2 rounded bg-black">
                      ...
                      <p className="text-sm text-white">By author on 9:00pm</p>
                      <div className="flex flex-row mt-4">
                        <div className="mr-1 text-white"><span>8</span></div>
                        <div className="mr-4">
                    ...
                    <div className="flex flex-row mt-4 px-3 py-3 bg-black">
                      <span className="text-xs text-cyan-50">Showing 1 to 10 of 20 results</span>
                      <div className="flex flex-row mb-3">
                      <form action="/logout" method="post"><button type="submit" className="bg-gray-900 text-white px-3 py-2 rounded-md text-xs font-medium">Previous</button></form>
                      <form action="/logout" method="post"><button type="submit" className="bg-gray-900 text-white px-3 py-2 rounded-md text-xs font-medium ml-2">Next</button></form>
                      </div>
                    </div>
                  </div>
