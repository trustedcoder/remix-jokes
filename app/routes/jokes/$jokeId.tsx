...
export default function JokeRoute(){
  const data = useLoaderData<typeof loader>();
    return (
        <div>
          <p className="border-solid border border-green-600 px-3 py-3 text-base"><Link className="text-lg text-green-500" to=".">{data.joke.name}</Link> By author on 23th of Aug 2022</p>
